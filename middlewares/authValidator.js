const { validateNotNull, validateRegex, validateType, validateMaxLength, validateLength } = require('../utils/validations');
...
const validations = {
    email: [
        ...
        (email, errors, method) => { method === methods.Register && validateMaxLength(email, 150, false, errors, 'Email\'s length can\'t exceed 150 characters'); },
    ...
    password: [
        ...
        (password, errors, method) => { method === methods.Register && validateLength(password, 5, 21, errors, 'Password must have a minimum length of 6 characters and a maximum length of 20 characters'); },
